...
Models when only considering $tp$ until the first 0 of the ACf for the Cases time series, $tp$ max is 17 weeks:

- Models until 17 weeks:
    * (Model III) S-Map for 
...
$$
\begin{eqnarray}
Cases(t) &=& C_0(t) + \frac{\partial Cases(t)}{\partial Precip_{min}(t - 25)}Precip_{min}(t - 25) \\
&+& \frac{\partial Cases(t)}{\partial Precip_{max}(t - 49)}Precip_{max}(t - 49) \\
&+& \frac{\partial Cases(t)}{\partial Precip_{mean}(t - 49)}Precip_{mean}(t - 49)
\end{eqnarray}
$$
...
&+& \frac{\partial Cases(t)}{\partial Precip_{max}(t - 49)}Precip_{max}(t - 49) \\
&+& \frac{\partial Cases(t)}{\partial Precip_{mean}(t - 49)}Precip_{mean}(t - 49) \\ 
&+& \frac{\partial Cases(t)}{\partial Temp_{min}(t)}Temp_{min}(t)
\end{eqnarray}
$$
...
$$
\begin{eqnarray}
Cases(t) &=& C_0(t) + \frac{\partial Cases(t)}{\partial Precip_{max}(t - 2)}Precip_{max}(t - 2) \\
...
$$
\begin{eqnarray}
Cases(t) &=& C_0(t) + \frac{\partial Cases(t)}{\partial Precip_{min}(t - 2)}Precip_{min}(t - 2) \\
&+& \frac{\partial Cases(t)}{\partial Precip_{max}(t - 7)}Precip_{max}(t - 7) \\
&+& \frac{\partial Cases(t)}{\partial Temp_{min}(t)}Temp_{min}(t) \\
\end{eqnarray}
$$
 ...
 * Choose maximum $tp$ to be tested, the only justified is 17 weeks by the ACF of cases
 * Choose if the S-Map includes temperature variables and which? $Temp_{min}$ has the highest $\rho$
 * Interpretation of the results, First attempt next slide
