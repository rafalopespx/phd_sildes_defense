...
With the at the time for prediction where the original driver is causal significant and where it is has the greater $\rho$ we estimate the force of interaction:
 ...
 - Two models: I) Adding Diff Cases in the SSR II) Diff Cases as the target for the smap
...
## S-Map Models
  ...
  * Model I) $\langle \Delta Case(t), Precip_{max}(t-2), Precip_{min}(t-7))\rangle$
  
  * Model II) $\langle Precip_{max}(t-2), Precip_{min}(t-7))\rangle$, but the target is the $\Delta Cases(t)$
...
$$\langle \Delta Cases(t), Precip_{max}(t-2), Precip_{min}(t-7))\rangle$$

---

```{r theta-modelI, echo=FALSE, message=FALSE, warning=FALSE, out.width=750, fig.align='center'}
knitr::include_graphics('img_v8/yearly_shuffle_tp_17_add_diffcases_theta_min_mae_rmse.png')
```
...
$$
\begin{eqnarray}
Cases(t) &=& C_0 + \frac{\partial Cases(t)}{\partial \Delta Cases(t)}\Delta Cases(t) \\
...
knitr::include_graphics('img_v8/patchwork_coef_precips_tp_17_add_diffCases.png')
```

---

```{r forcesII-modelI, , echo=FALSE, message=FALSE, warning=FALSE, out.width=750, fig.align='center'}
knitr::include_graphics('img_v8/patchwork_coef_all_tp_17_add_diffCases.png')
```
...
$$\langle Precip_{max}(t-2), Precip_{min}(t-7))\rangle$$


but the target is the $\Delta Cases(t)$

---

```{r theta-modelII, echo=FALSE, message=FALSE, warning=FALSE, out.width=750, fig.align='center'}
knitr::include_graphics('img_v8/yearly_shuffle_tp_17_add_diffcases_target_diffcases_theta_min_mae_rmse.png')
```
...
$$
\begin{eqnarray}
\Delta Cases(t) &=& C_0 + \frac{\partial \Delta Cases(t)}{\partial Precip_{max}(t - 2)}Precip_{max}(t - 2) \\
&+& \frac{\partial \Delta Cases(t)}{\partial Precip_{min}(t - 7)}Precip_{min}(t - 7)
\end{eqnarray}
$$

---

```{r forces-modelII, echo=FALSE, message=FALSE, warning=FALSE, out.width=800, fig.align='center'}
knitr::include_graphics('img_v8/patchwork_coef_precips_tp_17_add_diffcases_target_diffcases.png')
```
...
```{r echo=FALSE, message=FALSE, warning=FALSE, out.width=750, fig.align='center'}
knitr::include_graphics('img_v8/coef_precip_min_tp_17.png')
```

---

```{r echo=FALSE, message=FALSE, warning=FALSE, out.width=750, fig.align='center'}
knitr::include_graphics('img_v8/coef_precip_max_tp_17.png')
```

---

```{r echo=FALSE, message=FALSE, warning=FALSE, out.width=750, fig.align='center'}
knitr::include_graphics('img_v8/coef_precip_min_tp_17_add_diffCases.png')
```

---

```{r echo=FALSE, message=FALSE, warning=FALSE, out.width=750, fig.align='center'}
knitr::include_graphics('img_v8/coef_precip_max_tp_17_add_diffCases.png')
```

---

```{r echo=FALSE, message=FALSE, warning=FALSE, out.width=750, fig.align='center'}
knitr::include_graphics('img_v8/coef_casest1_tp_17_add_diffCases.png')
```
