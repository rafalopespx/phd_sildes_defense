...
knitr::include_graphics('img_v2/boxplot_all_tp_type.png')
```

---

```{r rj-boxplot-sig, echo=FALSE, message=FALSE, warning=FALSE, out.width=800, fig.align='center'}
knitr::include_graphics('img_v2/boxplot_drivers_tp_sig.png')
```
...
knitr::include_graphics('img_v2//theta_min_mae_rmse.png')
```
...
\frac{\partial Precip_{min}(t - 26 )}{\partial Cases(t)}Precip_{min}(t - 26)
\end{equation}
$$
