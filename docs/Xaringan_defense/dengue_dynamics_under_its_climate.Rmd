...
The time-series of cases shows:
  ...
  - Hyperendemicity, endemic epidemics of four different serotypes
...
EDM in practice, we seek for points in one __Shadow-Manifold__, say $\mathbf{M}_X$ with the same temporal indexes, into the other, say $\mathbf{M}_Y$, and we follow ahead those points $n$ steps, to give a prediction to the future of points into the other manifold, in a equation:
...
We apply The typical procedure of *EDM* on the time series of cases of Rio de Janeiro:
  ...
  4) The $tp$ with the original time series is above the 0.95th percentile of the $\rho_{CCM}$ distribution, it is a significant causal relation or __driver__
