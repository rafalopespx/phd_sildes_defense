...
$$
\begin{equation}
\rho_{CCM}(L) = \frac{Cov[O, P]}{\sigma_O \sigma_P}=\frac{Cov[Y,\hat{Y}|\mathbf{M_X}]}{\sigma_Y \sigma_{\hat{Y}|\mathbf{M_X}}}
\end{equation}
$$

If this correlation converges to a value, as we take more and more points, this is the criteria for the causality and linking between the both __Shadow-Manifolds__.
