...
EDM in practice is to give predictions, $\hat{Y}$, of points on one __Shadow_manifold__, $\mathbf{M}_Y$, given the dynamics of point with the same time indexes, onto other manifold, $\mathbf{M}_X$, in a equation:
