...
$$
\begin{eqnarray}
Cases(t) &=& C_0 + \frac{\partial Cases(t)}{\partial Cases(t-1)} + \frac{\partial Cases(t)}{\partial Cases(t-2)} \\
...
knitr::include_graphics('img_v7/patchwork_coef_all_tp_17.png')
```

---

```{r echo=FALSE, message=FALSE, warning=FALSE, out.width=750, fig.align='center'}
knitr::include_graphics('img_v7/coef_casest1_tp_17_add_cases.png')
```

---

```{r echo=FALSE, message=FALSE, warning=FALSE, out.width=750, fig.align='center'}
knitr::include_graphics('img_v7/coef_casest2_tp_17_add_cases.png')
```

---

```{r echo=FALSE, message=FALSE, warning=FALSE, out.width=750, fig.align='center'}
knitr::include_graphics('img_v7/coef_precip_min_tp_17_add_cases.png')
```

---

```{r echo=FALSE, message=FALSE, warning=FALSE, out.width=750, fig.align='center'}
knitr::include_graphics('img_v7/coef_precip_max_tp_17_add_cases.png')
```
