...
knitr::include_graphics('img_v4/patch_surrogates_temp.png')
```

---

```{r, echo=FALSE, message=FALSE, warning=FALSE, out.width=700, fig.align='center'}
knitr::include_graphics('img_v4/patch_surrogates_precip.png')
```
...
knitr::include_graphics('img_v4/boxplot_52_weeks_tp_type.png')
```

---

```{r rj-boxplot-sig, echo=FALSE, message=FALSE, warning=FALSE, out.width=800, fig.align='center'}
knitr::include_graphics('img_v4/boxplot_drivers_tp_sig.png')
```
